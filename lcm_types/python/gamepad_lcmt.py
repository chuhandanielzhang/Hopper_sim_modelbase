...
class gamepad_lcmt(object):
    ...
    def __init__(self):
        ...
        """ LCM Type: float """
        self.leftStickAnalog = [0.0 for _ in range(2)]
        """ LCM Type: float[2] """
        self.rightStickAnalog = [0.0 for _ in range(2)]
        """ LCM Type: float[2] """
    ...
    def _encode_one(self, buf):
        buf.write(
            struct.pack(
                ...
                self.leftBumper,
                self.rightBumper,
                self.leftTriggerButton,
                self.rightTriggerButton,
                self.home,
                self.start,
                self.select,
                self.thumbl,
                ...
                self.leftTriggerAnalog,
                self.rightTriggerAnalog,
            )
        )
    ...
    def _decode_one(buf):
        ...
        (
            ...
            self.leftTriggerAnalog,
            self.rightTriggerAnalog,
        ) = struct.unpack(">iiiiiiiiiiiiiiiiff", buf.read(72))
    ...
    def _get_hash_recursive(parents):
        if gamepad_lcmt in parents:
            return 0
        tmphash = (0xBC69AEE0053D67D0) & 0xFFFFFFFFFFFFFFFF
